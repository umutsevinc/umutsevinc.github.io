...
include_once('./php_mail/Mail.php');
include_once('./php_mail/Mail/mime.php');

//Settings
$max_allowed_file_size = 5000; // size in KB
$allowed_extensions = array("pdf", "doc", "docx");
$upload_folder = './uploads/'; //<-- this folder must be writeable by the script
$your_email = 'eloncheur@gmail.com';//<<--  update this to your email address
...
if(isset($_POST['submit']))
{
  ...
  if ($allowed_ext == true)
  {
    ...
    $text .= $phone;
		...
		$message->addAttachment($path_of_resume);
    $message->addAttachment($path_of_cover_letter);
		$body = $message->get();
                    ...
                    <div id="openModalJoin" class="modalJoin">
                        <div class="centerModal">
                            ...
                            <div class="field is-grouped">
                                <div class="control">
                                    <input type="submit" name="submit" class="button is-link"></button>
                                </div>
                            </div>
                          </form>
